...
const YOUTUBE_PLAYLIST_ID = process.env.YOUTUBE_PLAYLIST_ID || "PLBxZi83Hwl9A";
...
app.post("/api/youtube-upload", upload.single("video"), async (req, res) => {
  ...
  try {
    ...
    // Automatically add the newly uploaded video to the Oxorak Community playlist.
    ...
    res.json({
      ...
      playlistId: YOUTUBE_PLAYLIST_ID,
      playlistUrl: `https://www.youtube.com/playlist?list=${YOUTUBE_PLAYLIST_ID}`
    });
  } catch (e) {
